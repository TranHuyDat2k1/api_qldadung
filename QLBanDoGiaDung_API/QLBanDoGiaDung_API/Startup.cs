...
namespace QLBanDoGiaDung_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // configure strongly typed settings objects     //mã hóa sinh ra token
            var appSettingsSection = Configuration.GetSection("AppSettings");
            services.Configure<AppSettings>(appSettingsSection);

            // configure jwt authentication
            var appSettings = appSettingsSection.Get<AppSettings>();
            var key = Encoding.ASCII.GetBytes(appSettings.Secret);      //lấy ra mảng byte
            ...
            .AddJwtBearer(o =>
            {
                ...
                {
                    ValidateIssuerSigningKey = true,   // ký vào toekn
                    IssuerSigningKey = new SymmetricSecurityKey(key),

                    ValidateIssuer = false,  // tự cấp token
